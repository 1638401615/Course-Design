...
public class Posting extends AbstractPosting {
    public Posting(){}
    public Posting(int key, int size, List<Integer> value) {
        this.docId = key;
        this.freq = size;
    ...
    public boolean equals(Object obj) {
        if(obj instanceof Posting)
            return this.docId == ((Posting) obj).docId && this.freq == ((Posting) obj).freq && this.positions.containsAll(((Posting) obj).positions) && ((Posting) obj).positions.containsAll(this.positions);
        return false;
    }
    /**
     * 返回Posting的字符串表示
    ...
    @Override
    @SuppressWarnings("unchecked")//拿来消除positions那个读取的warning用的
